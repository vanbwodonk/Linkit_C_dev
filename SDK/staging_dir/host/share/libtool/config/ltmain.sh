...
if test -n "$STAGING_DIR"; then
	...
	: ${EGREP="/openwrt/CC/staging_dir/host/bin/grep -E"}
	: ${FGREP="/openwrt/CC/staging_dir/host/bin/grep -F"}
	: ${GREP="/openwrt/CC/staging_dir/host/bin/grep"}
	: ${SED="/openwrt/CC/staging_dir/host/bin/sed"}
fi
